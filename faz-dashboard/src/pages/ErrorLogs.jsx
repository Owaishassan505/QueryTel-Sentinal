...
import { Search, RotateCw, AlertCircle, Filter, Calendar, Printer, FileText } from "lucide-react";
...
export default function ErrorLogs() {
    ...
    const exportPDF = () => {
        ...
        const content = `
            <html>
                <head>
                    <title>SOC Critical Error Report</title>
                    <style>
                ...
                <body>
                    <h1>QueryTel SOC Critical Error Report</h1>
        ...
        <div className="space-y-6">
            <header className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest mt-1">High Severity Incidents</p>
                </div>
            ...
            <div className="bg-[#0f172a]/60 backdrop-blur-md p-4 rounded-2xl border border-slate-800 flex flex-wrap items-center gap-5">
                ...
                <div className="flex items-center gap-4 border-l border-slate-800 pl-4">
                    <div className="flex items-center gap-2">
                        ...
                        <input
                            type="date"
                            className="bg-black/20 border border-slate-800 text-[10px] font-bold text-slate-300 px-2 py-1.5 rounded-lg outline-none focus:border-red-500/50"
                            value={startDate}
                ...
                <div className="relative group flex-1 max-w-sm">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 rounded-xl border border-slate-800 bg-black/20 text-slate-300 placeholder:text-slate-600 focus:border-red-500/50 outline-none transition-all text-xs font-semibold shadow-inner"
                        value={search}
            ...
            <div className="bg-[#0f172a]/80 backdrop-blur-xl rounded-[2rem] border border-slate-800 overflow-hidden min-h-[600px] shadow-2xl">
                {loading ? (
                    <div className="flex flex-col items-center justify-center h-[600px] text-slate-400">
                        ...
                        <p className="text-xs font-black uppercase tracking-widest">Scanning Critical Audit Trails...</p>
                    </div>
                ) : (
